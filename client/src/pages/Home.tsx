  ...
  return (
    <a href="#top" className="logo" aria-label="Триумф — на главную">
      <span className="logo-symbol" aria-hidden="true">
        <img src={assetPath("triumph-logo.png")} alt="" />
      </span>
      ...
      <main>
        <section className="hero section-grid" aria-labelledby="hero-title">
          ...
          <div className="hero-image-wrap reveal delay-1">
            <img src={assetPath("artzvezda-hero.jpg")} alt="Молодые артисты выступают на сцене" className="hero-image" />
        ...
        <section id="directions" className="directions section-grid">
          ...
          <div className="discipline-photo reveal delay-1">
            <img src={assetPath("artzvezda-disciplines.jpg")} alt="Предметы, представляющие различные виды искусства" />
        ...
        <section className="story section-grid">
          <div className="story-photo reveal"><img src={assetPath("artzvezda-story.jpg")} alt="Юные творческие участники за кулисами" /></div>
